"""
Information Retrieval Preprocessor Service (CSD358)
===================================================
Handles document and query text preprocessing:
1. Tokenization (alphanumeric extraction, punctuation removal, char offsets)
2. Case Normalization (lowercasing)
3. Stop-Word Removal (consistent English stop-word policy)
4. Stemming (Porter Stemming Algorithm 1980)
"""
