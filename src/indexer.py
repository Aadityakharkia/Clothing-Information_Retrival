"""
Inverted Index and Positional Index Module (CSD358)
===================================================
...
class Document:
    ...
    def __init__(self, doc_id: str, category: str, title: str, text: str):
        ...
        self.title = title
        self.text = text
        self.combined_text = f"{title}. {text}"
        self.tokens: List[Tuple[str, int, int, int]] = []  # (term, pos, start_char, end_char)
        self.tf_dict: Dict[str, int] = {}
        self.positions_dict: Dict[str, List[int]] = {}
        self.char_spans_dict: Dict[str, List[Tuple[int, int]]] = {}
        self.vector_length: float = 0.0  # Euclidean length under lnc
